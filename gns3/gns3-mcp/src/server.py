...
ACTIONS: list[dict] = [
    {"name": "start_all_nodes", "description": "Start all nodes", "params": {}, "types": []},
    {"name": "stop_all_nodes", "description": "Stop all nodes", "params": {}, "types": []},
    {
        "name": "start_node",
    ...
    {
        "name": "isolate_node",
        "description": "Disable all node links",
        "params": {"node_id": {"type": "string"}},
        "types": ["vpcs", "qemu", "dynamips", "docker"],
    },
    {
        "name": "unisolate_node",
        "description": "Restore node links",
        "params": {"node_id": {"type": "string"}},
        "types": ["vpcs", "qemu", "dynamips", "docker"],
    },
    {
    ...
    {"name": "open_project", "description": "Open the project", "params": {}, "types": []},
    {"name": "close_project", "description": "Close the project", "params": {}, "types": []},
    {
