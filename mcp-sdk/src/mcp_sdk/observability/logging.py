...
def configure_logging(
    ...
    for name in ("uvicorn", "uvicorn.error"):
        ...
        lg.handlers = []
        lg.propagate = True
    # RequestIDMiddleware already logs one request_handled line per request, so
    # uvicorn.access would double every one. Silenced here regardless of whether
    # uvicorn was started with --no-access-log.
