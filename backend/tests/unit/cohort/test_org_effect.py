...
from cohort.metrics import SURVIVORSHIP_NOTE, LearnerOutcome, org_effect_trend
...
class TestOrgEffect:
    ...
    def test_bf4b4d6e_trend_descriptive_and_tagged(self):
        ...
        with autotest.step("Assert: means and the survivorship note are correct"):
            ...
            assert_true("описатель" in t.note.lower(), "note is tagged as descriptive")
            assert_equal(t.note, SURVIVORSHIP_NOTE, "note == SURVIVORSHIP_NOTE")
    ...
    def test_88f109b7_l2_means_none_when_no_l2(self):
        ...
        with autotest.step("Assert: l2_escalations_mean is None"):
            assert_is_none(t.l2_escalations_mean, "l2_escalations_mean is None when there is no L2")
