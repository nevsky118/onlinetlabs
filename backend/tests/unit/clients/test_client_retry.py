...
Strategy: patch the transport in mcp_client.connection to control
...
class TestMCPClientRetry:
    ...
    async def test_0326bce7_retry_succeeds_on_second_attempt(self):
        ...
        with autotest.step("Act: patch streamablehttp_client and ClientSession, call _call_tool"):
            with (
                patch("clients.mcp_connection.streamablehttp_client", fake_streamable),
                patch(
                    "clients.mcp_connection.ClientSession",
    ...
    async def test_4ca60575_all_attempts_fail_reraises(self):
        ...
        with (
            ...
            patch(
                "clients.mcp_connection.streamablehttp_client",
