...
async def test_f504a542_node_action_204_returns_none():
    with autotest.step("Arrange: mock the node start endpoint to return 204 and build the client"):
...
async def test_bb23eb2c_bulk_node_action_204():
    with autotest.step("Arrange: mock the bulk stop endpoint to return 204 and build the client"):
        sid = "11111111-1111-1111-1111-111111111111"
