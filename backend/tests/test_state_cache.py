...
async def test_91faa4b2_get_returns_none_on_miss():
...
async def test_7e244144_get_returns_parsed_state_on_hit():
...
async def test_6795587c_set_writes_json_with_ttl():
...
async def test_8f82db15_invalidate_deletes_key():
...
async def test_498b2733_get_returns_none_on_corrupted_json():
