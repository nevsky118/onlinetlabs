"""Tutor streaming pipeline. The router only wires HTTP to stream_reply."""
...
from clients.llm import build_client, model_supports_tools, model_uri
...
async def stream_reply(
    ...
    """Validates the request and returns the SSE generator for the tutor reply.

    Takes the request itself: the loop stops early when the client disconnects.
    """
