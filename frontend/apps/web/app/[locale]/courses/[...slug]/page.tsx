...
export async function generateMetadata(props: {
  ...
  const page = course.getPage(params.slug, params.locale)
...
export default async function Page(props: {
  ...
  const [t, tMdx] = await Promise.all([
    getTranslations("web.coursesDoc"),
  ...
  const doc = page.data
  const MDX = doc.body
  const neighbours = findNeighbour(course.getPageTree(params.locale), page.url)
